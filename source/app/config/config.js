...
class Config {
    ...
    "large_language_model" = {
        llm_provider: new ConfigFieldSelect({
            ...
            reload: true,
            type: "select",
            options: ["groq", "novelai"],
            default: "groq",
            value: "groq",
        }),
        groq_model: new ConfigFieldSelect({
            hint: "Model used when selecting Groq as LLM provider. llama-3.3-70b-versatile recommended for best quality.",
            reload: false,
            type: "select",
            options: [
